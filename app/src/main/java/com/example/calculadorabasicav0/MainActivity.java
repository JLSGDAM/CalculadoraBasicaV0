package com.example.calculadorabasicav0;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_Add = (Button) findViewById(R.id.btnSuma);
        button_Sub = (Button) findViewById(R.id.btnResta);
        button_Mul = (Button) findViewById(R.id.btnMulti);
        button_Div = (Button) findViewById(R.id.btnDivision);
        button_Remainder = (Button) findViewById(R.id.btnPorciento);
        button_Del = (Button) findViewById(R.id.btnBorrar);
